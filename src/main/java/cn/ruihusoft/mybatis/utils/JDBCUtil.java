...
public class JDBCUtil {
    ...
    public static String getMysqlDbName(String url) {
        Matcher matcher = JDBCUtil.getPattern("jdbc:mysql://{host}[:{port}]/[{database}][\\?{params}]")
                .matcher(url);
        if (matcher.matches()) {
    ...
    public static void main(String[] args) {
        ...
        final Matcher matcher0 = JDBCUtil.getPattern("jdbc:teradata://{host}/DATABASE={database},DBS_PORT={port}[,{params}]").matcher(
                "jdbc:teradata://localhost/DATABASE=test,DBS_PORT=1234,CLIENT_CHARSET=EUC_CN,TMODE=TERA,CHARSET=ASCII,LOB_SUPPORT=true");
        if (matcher0.matches()) {
        ...
        final Matcher matcher1 = JDBCUtil.getPattern("jdbc:postgresql://{host}[:{port}]/[{database}][\\?{params}]")
        ...
        // 3、Oracle数据库
        // oracle sid 方式
        final Matcher matcher2 = JDBCUtil.getPattern("jdbc:oracle:thin:@{host}[:{port}]:{sid}")
        ...
        final Matcher matcher2_1 = JDBCUtil.getPattern("jdbc:oracle:thin:@//{host}[:{port}]/{name}")
        ...
        final Matcher matcher3 = JDBCUtil.getPattern("jdbc:mysql://{host}[:{port}]/[{database}][\\?{params}]")
        ...
        // 5、MariaDB数据库
        // 同Mysql的jdbc-url
        final Matcher matcher4 = JDBCUtil.getPattern("jdbc:mariadb://{host}[:{port}]/[{database}][\\?{params}]")
        ...
        final Matcher matcher5 = JDBCUtil
        ...
        final Matcher matcher6 = JDBCUtil.getPattern("jdbc:kingbase8://{host}[:{port}]/[{database}][\\?{params}]")
        ...
        final Matcher matcher7 = JDBCUtil.getPattern("jdbc:dm://{host}:{port}[/{database}][\\?{params}]")
        ...
        final Matcher matcher8 = JDBCUtil.getPattern("jdbc:db2://{host}:{port}/{database}[:{params}]")
        ...
        final Matcher matcher9 = JDBCUtil.getPattern("jdbc:sqlite:{file}")
